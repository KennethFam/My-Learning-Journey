...
const emailErr = "is an invalid email.";
const ageErr = "must be a whole number between 18 and 120";
const bioErr = "can only be at most 200 characters";
...
// adding validateUser registers it as middleware and has it run first, next() is called implicitly
